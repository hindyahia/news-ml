        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <!--begin::Menu Nav-->
                    <ul class="menu-nav">
                        {{--                        <li class="menu-item {{request()->fullUrlIs(url(getLocal().'/admin/home'))? "menu-item-here" : ''}}"--}}
                        {{--                            aria-haspopup="true">--}}
                        ...
                        <li class="menu-item {{request()->fullUrlIs(url('admin/keywords*'))? "menu-item-here" : ''}}"
                            aria-haspopup="true">
                        ...
                        <li class="menu-item {{request()->fullUrlIs(url('admin/contents*'))? "menu-item-here" : ''}}"
                            aria-haspopup="true">
