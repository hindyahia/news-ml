                                                                ...
                                                                <div class="col-lg-6 col-xl-3 mb-5">
                                                                    ...
                                                                    <div class="card card-custom wave wave-animate-fast">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$keywords_count}}</span>
                                                                ...
                                                                <div class="col-lg-6 col-xl-3 mb-5">
                                                                    ...
                                                                    <div class="card card-custom wave wave-animate-fast">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$articles_count}}</span>
