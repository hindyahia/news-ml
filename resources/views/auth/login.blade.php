                ...
                <div class="login-form login-signin">
                    ...
                    <form class="form" method="post" action="{{ route('login') }}" novalidate="novalidate" id="kt_login_signin_form">
                        ...
                        <div class="form-group text-right" >
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 text-right rounded-lg" type="email" required value="{{old('email')}}" name="email" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group text-right">
                            <div class="d-flex justify-content-end mt-n5 text-right" >
                                <label class="font-size-h6 font-weight-bolder text-dark pt-5 "  >@lang('cp.password')</label>
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg text-right" type="password" name="password" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Action-->
                        <div class="pb-lg-0 pb-5">
                            <button type="submit"  class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">@lang('cp.login')</button>
